...
First, we read in the data frame and organize it into a data frame of SNP-gene pair x tissues. Here I show how to create the appropriate data frame for Z statistics, and repeat the same logic to create a similar J x R frame for se.
